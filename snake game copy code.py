...
class Snake:
    def __init__(self, snake_color):
        open_eyes = pygame.image.load(r"C:\Users\LENOVO\OneDrive\Documents\GitHub\Snake-game-project\eye_closed.png").convert_alpha()
...
def settings():
    ...
    light_bg = pygame.image.load(r"C:\Users\LENOVO\OneDrive\Documents\GitHub\Snake-game-project\background.png").convert_alpha()
    light_bg = pygame.transform.scale(light_bg, (120, 120))
    light_bg_rect = light_bg.get_rect(center= (300, 160))

    night_bg = pygame.image.load(r"C:\Users\LENOVO\OneDrive\Documents\GitHub\Snake-game-project\background.png").convert_alpha()
...
background = pygame.image.load(r"C:\Users\LENOVO\OneDrive\Documents\GitHub\Snake-game-project\background.png").convert_alpha()
